...
public class CompatCrops {
    ...
    @Nullable
    public static final Crop BRONZE = Crops.compat("bronze", "#forge:ingots/bronze", 0xC48553, 3, CropType.CROP, Map.of(
    ...
    @Nullable
    public static final Crop STEEL = Crops.compat("steel", "#forge:ingots/steel", 0xA0A0A0, 3, CropType.CROP, Map.of(
