...
public class ConfigCommand {
    private static final LiteralArgumentBuilder<CommandSourceStack> INFUSOR = Commands.literal("infusor").executes(context -> {
        context.getSource().sendSuccess(new TranslatableComponent("commands.croparia.config.infusor", CropariaIf.CONFIG.getInfusor().toString()), false);
        return 1;
    ...
    private static final LiteralArgumentBuilder<CommandSourceStack> RITUAL = Commands.literal("ritual").executes(context -> {
        context.getSource().sendSuccess(new TranslatableComponent("commands.croparia.config.ritual", CropariaIf.CONFIG.getRitual().toString()), false);
        return 1;
    }).then(Commands.argument("value", BoolArgumentType.bool()).executes(context -> {
        ...
        context.getSource().sendSuccess(new TranslatableComponent("commands.croparia.config.fruitUse", CropariaIf.CONFIG.getFruitUse().toString()), false);
        return 1;
    }).then(Commands.argument("value", BoolArgumentType.bool()).executes(context -> {
    ...
    private static final LiteralArgumentBuilder<CommandSourceStack> AUTO_RELOAD = Commands.literal("dump").executes(context -> {
        context.getSource().sendSuccess(new TranslatableComponent("commands.croparia.config.autoReload", CropariaIf.CONFIG.getAutoReload().toString()), false);
        return 1;
    }).then(Commands.argument("value", BoolArgumentType.bool()).executes(context -> {
    ...
    private static final LiteralArgumentBuilder<CommandSourceStack> OVERRIDE = Commands.literal("OVERRIDE").executes(context -> {
        context.getSource().sendSuccess(new TranslatableComponent("commands.croparia.config.override", CropariaIf.CONFIG.getOverride().toString()), false);
        return 1;
    }).then(Commands.argument("value", BoolArgumentType.bool()).executes(context -> {
