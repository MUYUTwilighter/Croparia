...
public class RepoUnit<T extends ResourceType> implements Repo<T> {
    ...
    public void load(JsonObject json) {
        this.resource = this.getType().codec().codec().decode(JsonOps.INSTANCE, json.get("resource")).getOrThrow(
            false, msg -> {
    ...
    public void load(CompoundTag nbt) {
        this.setResource(this.getType().codec().codec().decode(NbtOps.INSTANCE, nbt.get("resource")).getOrThrow(
            false, msg -> {
                throw new IllegalArgumentException(msg);
            }
        ).getFirst());
    ...
    public void save(JsonObject json) {
        json.add("resource", this.getType().codec().codec().encodeStart(
            JsonOps.INSTANCE, this.getResource()
    ...
    public void save(CompoundTag nbt) {
        nbt.put("resource", this.getType().codec().codec().encodeStart(
            NbtOps.INSTANCE, this.getResource()
        ).getOrThrow(false, msg -> {
            throw new IllegalArgumentException(msg);
        }));
