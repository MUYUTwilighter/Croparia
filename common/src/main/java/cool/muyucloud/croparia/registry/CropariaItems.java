...
public class CropariaItems {
    ...
    public static final RegistrySupplier<ElementalPotion> POTION_ELEMATILIUS = registerItem(
        "potion_elematilius",
        () -> new ElementalPotion(ElementsEnum.ELEMENTAL, new Item.Properties().tab(Tabs.MAIN).craftRemainder(Items.GLASS_BOTTLE))
    );
    public static final RegistrySupplier<ElementalPotion> POTION_WATER = registerItem(
        "potion_water",
        () -> new ElementalPotion(ElementsEnum.WATER, new Item.Properties().tab(Tabs.MAIN).craftRemainder(Items.GLASS_BOTTLE))
    );
    public static final RegistrySupplier<ElementalPotion> POTION_FIRE = registerItem(
        "potion_fire",
        () -> new ElementalPotion(ElementsEnum.FIRE, new Item.Properties().tab(Tabs.MAIN).craftRemainder(Items.GLASS_BOTTLE))
    );
    public static final RegistrySupplier<ElementalPotion> POTION_EARTH = registerItem(
        "potion_earth",
        () -> new ElementalPotion(ElementsEnum.EARTH, new Item.Properties().tab(Tabs.MAIN).craftRemainder(Items.GLASS_BOTTLE))
    );
    public static final RegistrySupplier<ElementalPotion> POTION_AIR = registerItem(
        "potion_air",
        () -> new ElementalPotion(ElementsEnum.AIR, new Item.Properties().tab(Tabs.MAIN).craftRemainder(Items.GLASS_BOTTLE))
    );
    @PostReg
    ...
    public static final RegistrySupplier<Item> CROPARIA = registerItem(
        "croparia", () -> new Croparia(1, new Item.Properties().tab(Tabs.MAIN))
    );
    @PostReg
    public static final RegistrySupplier<Item> CROPARIA2 = registerItem(
        "croparia2", () -> new Croparia(2, new Item.Properties().tab(Tabs.MAIN))
    );
    @PostReg
    public static final RegistrySupplier<Item> CROPARIA3 = registerItem(
        "croparia3", () -> new Croparia(3, new Item.Properties().tab(Tabs.MAIN))
    );
    @PostReg
    public static final RegistrySupplier<Item> CROPARIA4 = registerItem(
        "croparia4", () -> new Croparia(4, new Item.Properties().tab(Tabs.MAIN))
    );
    @PostReg
    public static final RegistrySupplier<Item> CROPARIA5 = registerItem(
        "croparia5", () -> new Croparia(5, new Item.Properties().tab(Tabs.MAIN))
    );
    @PostReg
    public static final RegistrySupplier<Item> CROPARIA6 = registerItem(
        "croparia6", () -> new Croparia(6, new Item.Properties().tab(Tabs.MAIN))
    );
    @PostReg
    public static final RegistrySupplier<Item> CROPARIA7 = registerItem(
        "croparia7", () -> new Croparia(7, new Item.Properties().tab(Tabs.MAIN))
    );
    @PostReg
    ...
    public static final RegistrySupplier<Item> ELEMATILIUS_BUCKET = registerItem(
        "elematilius_bucket",
        () -> new ElementalBucket(ElementsEnum.ELEMENTAL, Fluids.ELEMATILIUS, new Item.Properties().tab(Tabs.MAIN).stacksTo(1).craftRemainder(Items.BUCKET))
    );
    @PostReg
    public static final RegistrySupplier<Item> EARTH_BUCKET = registerItem(
        "earth_bucket",
        () -> new ElementalBucket(ElementsEnum.EARTH, Fluids.EARTH, new Item.Properties().tab(Tabs.MAIN).stacksTo(1).craftRemainder(Items.BUCKET))
    );
    @PostReg
    public static final RegistrySupplier<Item> WATER_BUCKET = registerItem(
        "water_bucket",
        () -> new ElementalBucket(ElementsEnum.WATER, Fluids.WATER, new Item.Properties().tab(Tabs.MAIN).stacksTo(1).craftRemainder(Items.BUCKET))
    );
    @PostReg
    public static final RegistrySupplier<Item> FIRE_BUCKET = registerItem(
        "fire_bucket",
        () -> new ElementalBucket(ElementsEnum.FIRE, Fluids.FIRE, new Item.Properties().tab(Tabs.MAIN).stacksTo(1).craftRemainder(Items.BUCKET))
    );
    @PostReg
    public static final RegistrySupplier<Item> AIR_BUCKET = registerItem(
        "air_bucket",
        () -> new ElementalBucket(ElementsEnum.AIR, Fluids.AIR, new Item.Properties().tab(Tabs.MAIN).stacksTo(1).craftRemainder(Items.BUCKET))
    );
