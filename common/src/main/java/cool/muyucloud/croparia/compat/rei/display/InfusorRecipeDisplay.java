...
public class InfusorRecipeDisplay implements SimpleDisplay<InfusorRecipe> {
    public static final DisplaySerializer<InfusorRecipeDisplay> SERIALIZER = DisplayFactory.serializer(
        InfusorRecipeSerializer.CODEC.codec(), InfusorRecipeDisplay::new
    );
    private final InfusorRecipe recipe;
    private final ResourceLocation id;

    @Override
    public InfusorRecipe getRecipe() {
        return this.recipe;
    }
