...
public class Crops {
    ...
    public static final Crop ELEMENTAL = registerCrop("elemental", "croparia:elematilius", 0x712389, 3, CropType.CROP, "item.croparia.elematilius");public static final Crop COAL = registerCrop("coal", Objects.requireNonNull(Items.COAL.arch$registryName()).toString(), 0x333333, 1, CropType.CROP, Items.COAL.getDescriptionId());
