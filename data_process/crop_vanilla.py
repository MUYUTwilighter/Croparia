...
# Replacement pattern for the desired structure
replacement = r'public static final Crop \1 = vanilla("\2", Items.\3, \4, \5, \6);'

# Perform the replacement
converted_data = pattern.sub(replacement, original_data)
